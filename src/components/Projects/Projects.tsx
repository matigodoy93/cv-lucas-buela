    ...
    <section id="home-projects" ref={projectsHomeRef} className="h-full px-8 py-10">
      ...
      <div className="lg:flex lg:flex-wrap lg:justify-center">
        ...
        <div className="mb-4 lg:w-2/4 md:mb-40">
          <h4 className="text-3xl text-bold text-center leading-6 mb-6 md:text-4xl uppercase">{ t('cinemaOnline.title') }</h4>
            {/* Títulos */}
            <Link to="/project/online-cinema">
              <div className="w-full h-60 md:h-72 flex flex-col items-center md:w-3/4 md:mx-auto lg:w-full lg:mb-12">
                <div className=" project-glow project bg-blue-900 transition-all ease-in-out w-full duration-300 lg:w-3/4 rounded-xl mb-10 lg:mb-0 lg:relative hover:-translate-y-1 lg:opacity-75 lg:hover:opacity-100">
                  <img className='h-auto lg:h-100 w-full' src={project1} alt="Certificado de aprobación en Educación IT" />
                </div>
              </div>
            </Link>
        </div>
        ...
        <div className="mb-4 lg:w-2/4 md:mb-40">
          <h4 className="text-3xl text-center leading-6 mb-6 md:text-4xl uppercase">Valiant</h4>
            {/* Títulos */}
            <Link to="/project/valiant">
              <div className="w-full h-60 md:h-72 flex flex-col items-center md:w-3/4 md:mx-auto lg:w-full lg:mb-12">
                <div className=" project-glow project bg-blue-900 transition-all ease-in-out w-full duration-300 lg:w-3/4 rounded-xl mb-10 lg:mb-0 lg:relative hover:-translate-y-1 lg:opacity-75 lg:hover:opacity-100">
                  <img className='h-auto lg:h-100 w-full' src={project2} alt="Certificado de aprobación en Educación IT" />
                </div>
              </div>
            </Link>
        </div>
        ...
        <div className="mb-4 lg:w-2/4 md:mb-40">
          <h4 className="text-3xl text-center leading-6 mb-6 md:text-4xl uppercase">FARMACONECTA</h4>
            {/* Títulos */}
            <Link to="/project/farmaconecta">
              <div className="w-full h-60 md:h-72 flex flex-col items-center md:w-3/4 md:mx-auto lg:w-full lg:mb-12">
                <div className=" project-glow project bg-blue-900 transition-all ease-in-out w-full duration-300 lg:w-3/4 rounded-xl mb-10 lg:mb-0 lg:relative hover:-translate-y-1 lg:opacity-75 lg:hover:opacity-100">
                  <img className='h-auto lg:h-100 w-full' src={project3} alt="FARMACONECTA" />
                </div>
              </div>
            </Link>
        </div>
        ...
        <div className="mb-4 lg:w-2/4 md:mb-40">
          <h4 className="text-3xl text-center leading-6 mb-6 md:text-4xl uppercase">Final Da Vinci - UX Research</h4>
            {/* Títulos */}
            <Link to="/project/davinci">
              <div className="w-full h-60 md:h-72 flex flex-col items-center md:w-3/4 md:mx-auto lg:w-full lg:mb-12">
                <div className=" project-glow project bg-blue-900 transition-all ease-in-out w-full duration-300 lg:w-3/4 rounded-xl mb-10 lg:mb-0 lg:relative hover:-translate-y-1 lg:opacity-75 lg:hover:opacity-100">
                  <img className='h-auto lg:h-100 w-full' src={project4} alt="Final Davinci - UX Research" />
                </div>
              </div>
            </Link>
        </div>
