...
export const Contact = () => {
  ...
  return (
    <section id="contact" ref={contactRef} className='bg-blue-900 py-10 mt-20'>
          ...
          <div className="flex md:justify-center">
            ...
            <div className="flex items-center">
              <a href="https://www.fiverr.com" target="_blank" className="overflow-hidden mx-4">
                <svg xmlns="http://www.w3.org/2000/svg" fill="#fff" x="0px" y="0px" width="60" height="60" viewBox="0 0 50 50">
