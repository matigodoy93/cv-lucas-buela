...
export const Contact = () => {
  ...
  return (
    <section id="contact" ref={contactRef} className='bg-blue-900 py-10'>
        ...
        <p className="text-center text-xl mb-8 mx-6 md:mx-0">👋 { t('thanks') }</p>
        
        <div className="w-3/4 md:w-2/4 mx-auto">
          <div className="flex justify-center items-center">

            <a href="https://www.linkedin.com/in/lucas-buela-/" target="_blank" className="flex justify-center items-center w-10 h-10 overflow-hidden mx-2 md:mx-5">
              <FontAwesomeIcon size="2xl" icon={faLinkedin} />
            </a>

            <a href="https://github.com/LucasBuela" target="_blank" className="flex justify-center items-center w-10 h-10 overflow-hidden mx-2 md:mx-5">
              <FontAwesomeIcon size="2xl" icon={faGithub} />
            </a>

            <a href="https://www.behance.net/lukabuela" target="_blank" className="flex justify-center items-center w-10 h-10 overflow-hidden mx-2 md:mx-5">
              <FontAwesomeIcon size="2xl" icon={faBehance} />
            </a>

            <a href="https://www.fiverr.com" target="_blank" className="flex justify-center items-center w-10 h-10 overflow-hidden mx-2 md:mx-5">
            ...
            <a href="https://www.instagram.com" target="_blank" className="flex justify-center items-center w-10 h-10 overflow-hidden mx-2 md:mx-5">
