...
export const Education = () => {
  return (
    <section id="education" className="h-screen px-6 bg-yellow-600">
      ...
      <div className="flex flex-col mb-6">
        ...
        <div className="mb-4">
          ...
          <p className="text-xl text-justify leading-6">Analista de sistemas/Diseñador UX/UI |
          2021-En curso</p>
        </div>

        <div className="">
          <h4 className="text-2xl text-center mb-2 leading-6">Educacion IT</h4>
          <p className="text-xl text-justify leading-6">Tester QA Manual/Automation Selenium | 2023 (Finalizado)</p>
        </div>
