...
export const AboutMe = () => {
  ...
  return (
    <section id="about" ref={aboutRef} className='h-full md:h-screen px-8 py-10 md:mt-24 md:pb-40 md:flex md:items-center'>
      
      <div className="md:flex md:flex-row md:me-20">
        {/* Foto */}
        <div className="photo-face w-80 h-80 overflow-hidden mx-auto bg-red-700 rounded-full mb-6">
