              ...
              <div className="lg:flex lg:justify-between">
                  <article className="w-full lg:flex lg:flex-col lg:justify-center lg:items-center ">
                      <div className="w-full mb-5 lg:w-2/4">
                          <h4 className="text-4xl text-center py-5 uppercase lg:text-center">{ t('farmaconecta.designDecisions') }</h4>
                      </div>
  
                      <div className="w-full appear-animation">
                          <img className="w-full" src={image2} alt={ t('farmaconecta.designDecisions') } />
                      </div>
                  </article>
              </div>
              <hr className="mt-10" />
